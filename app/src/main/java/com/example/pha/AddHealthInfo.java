...
public class AddHealthInfo extends AppCompatActivity {
    ...
    public void getDataFromFragments(){
        ...
        HealthInfo healthInfo=new HealthInfo(Integer.parseInt(age), Integer.parseInt(height_in), Integer.parseInt(height_ft), Integer.parseInt(weight), bp.getText().toString(), sgr.getText().toString(), vac.getText().toString(), bg);
